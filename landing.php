...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="pics/logo.webp">
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light align-text-right>

<a class="navbar-brand" href="#">SAFARI</a>

<!--        <img src="pics/support.jpg" alt="" width="50" height="30" class="d-inline-block align-text-top">-->
<!--        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">&ndash;&gt;-->
<!--            <span class="navbar-toggler-icon"></span>-->
<!--        </button>-->
        <div class="collapse navbar-collapse" id="navbarNavDropdown">

                <ul class="navbar-nav ms-auto mb-2 m">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="#">Comment Here</a></li>
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="pics/drive.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
                <h5>Book Here</h5>
                <p style="font-family: fantasy">Some representative placeholder content for the first slide.</p>
                <div class="slider-btn">
                    <button class="btn btn-1">Get Ticket</button>
                    <button class="btn btn-2">Welcome</button>
                </div>
            </div>
        </div>
